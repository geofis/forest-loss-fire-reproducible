...
- Dataset: `forest-loss-fire-reproducible-data-repo.zip`. Download it from [ZENODO](https://doi.org/10.5281/zenodo.5682103)
...
Visit [ZENODO](https://doi.org/10.5281/zenodo.5682103), download `forest-loss-fire-reproducible-data-repo.zip` (preserve its name, otherwise, won't work) and place the ZIP file in this repo (e.g. in the same directory containing this document).
...
# jpeg('out/moran_plots_forest_loss_fires_0118_1218.jpg', width = 3840, height = 2160, res = 300)
