...
`Fire and forest loss in the Dominican Republic during the 21st
...
\NormalTok{common\_ts\_comparison }\OtherTok{\textless{}{-}}\NormalTok{ firesm6sel2\_for\_comparison\_tb }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{rename}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{MODIS}\StringTok{\textasciigrave{}} \OtherTok{=}\NormalTok{ monthly\_sum) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{inner\_join}\NormalTok{(firesv1sel2\_tb }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{rename}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{VIIRS}\StringTok{\textasciigrave{}} \OtherTok{=}\NormalTok{ monthly\_sum))}
\NormalTok{common\_ts\_comparison\_p }\OtherTok{\textless{}{-}}\NormalTok{ common\_ts\_comparison }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{gather}\NormalTok{(}\StringTok{\textasciigrave{}}\AttributeTok{Sensor}\StringTok{\textasciigrave{}}\NormalTok{, value, }\SpecialCharTok{{-}}\NormalTok{year\_month) }\SpecialCharTok{\%\textgreater{}\%} 
\NormalTok{  ggplot }\SpecialCharTok{+} \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ year\_month, }\AttributeTok{y =}\NormalTok{ value, }\AttributeTok{group =} \StringTok{\textasciigrave{}}\AttributeTok{Sensor}\StringTok{\textasciigrave{}}\NormalTok{, }\AttributeTok{color =} \StringTok{\textasciigrave{}}\AttributeTok{Sensor}\StringTok{\textasciigrave{}}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{\textquotesingle{}loess\textquotesingle{}}\NormalTok{, }\AttributeTok{span =} \FloatTok{0.3}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.3}\NormalTok{, }\AttributeTok{color =} \StringTok{\textquotesingle{}grey\textquotesingle{}}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{lwd =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FunctionTok{as.numeric}\NormalTok{(common\_ts\_comparison}\SpecialCharTok{$}\NormalTok{year\_month[}\FunctionTok{yday}\NormalTok{(common\_ts\_comparison}\SpecialCharTok{$}\NormalTok{year\_month)}\SpecialCharTok{==}\DecValTok{1}\NormalTok{] }\SpecialCharTok{+} \DecValTok{15}\NormalTok{), }\AttributeTok{colour=}\StringTok{"grey60"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{expand\_limits}\NormalTok{(}\AttributeTok{x =} \FunctionTok{as.Date}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}2012{-}01{-}01\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}2019{-}01{-}01\textquotesingle{}}\NormalTok{))) }\SpecialCharTok{+}
  \FunctionTok{scale\_x\_date}\NormalTok{(}\AttributeTok{breaks=}\FunctionTok{pretty\_breaks}\NormalTok{(}\DecValTok{7}\NormalTok{), }\AttributeTok{date\_minor\_breaks=}\StringTok{"1 month"}\NormalTok{, }\AttributeTok{date\_labels =} \StringTok{\textquotesingle{}\%Y{-}\%m\textquotesingle{}}\NormalTok{, }\AttributeTok{expand =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{)) }\SpecialCharTok{+} 
...
\CommentTok{\# Correlation and lineal dependency}
\DocumentationTok{\#\# Correlation}
\FunctionTok{cor.test}\NormalTok{(firesm6sel2\_for\_comparison\_tb}\SpecialCharTok{$}\NormalTok{monthly\_sum, firesv1sel2\_tb}\SpecialCharTok{$}\NormalTok{monthly\_sum)}
\DocumentationTok{\#\# }
\DocumentationTok{\#\#  Pearson\textquotesingle{}s product{-}moment correlation}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# data:  firesm6sel2\_for\_comparison\_tb$monthly\_sum and firesv1sel2\_tb$monthly\_sum}
\DocumentationTok{\#\# t = 32.707, df = 82, p{-}value \textless{} 2.2e{-}16}
...
\DocumentationTok{\#\#  0.9445063 0.9763954}
\DocumentationTok{\#\# sample estimates:}
\DocumentationTok{\#\#       cor }
\DocumentationTok{\#\# 0.9637453}
\CommentTok{\# Cross{-}correlation function}
\CommentTok{\# jpeg(\textquotesingle{}img/data{-}download{-}preparation{-}eda/modis\_viirs\_2012\_2018\_cross\_correlation.jpg\textquotesingle{}, width = 3840, height = 1600, res = 350)}
\NormalTok{par\_mar\_orig }\OtherTok{\textless{}{-}} \FunctionTok{par}\NormalTok{(}\StringTok{\textquotesingle{}mar\textquotesingle{}}\NormalTok{)}
\NormalTok{par\_mar }\OtherTok{\textless{}{-}}\NormalTok{ par\_mar\_orig}
\NormalTok{par\_mar[}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{)] }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{, }\FloatTok{0.5}\NormalTok{)}
\FunctionTok{par}\NormalTok{(}\AttributeTok{mar =}\NormalTok{ par\_mar)}
\FunctionTok{ccf}\NormalTok{(firesm6sel2\_for\_comparison\_tb}\SpecialCharTok{$}\NormalTok{monthly\_sum, firesv1sel2\_tb}\SpecialCharTok{$}\NormalTok{monthly\_sum,}
    \AttributeTok{lag.max =} \DecValTok{12}\NormalTok{, }\AttributeTok{main =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}cross{-}correlation\textquotesingle{}}\NormalTok{, }\AttributeTok{xlab =} \StringTok{\textquotesingle{}lag\textquotesingle{}}\NormalTok{,}
    \AttributeTok{xlim =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{12}\NormalTok{, }\DecValTok{12}\NormalTok{), }\AttributeTok{xaxt =} \StringTok{\textquotesingle{}n\textquotesingle{}}\NormalTok{)}
\FunctionTok{axis}\NormalTok{(}\AttributeTok{side =} \DecValTok{1}\NormalTok{, }\AttributeTok{at =} \FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{12}\NormalTok{, }\DecValTok{12}\NormalTok{, }\DecValTok{2}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.75\linewidth]{img/data-download-preparation-eda/unnamed-chunk-1-6} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{par}\NormalTok{(}\AttributeTok{mar =}\NormalTok{ par\_mar\_orig)}
\CommentTok{\# dev.off()}
\FunctionTok{lag2.plot}\NormalTok{(}
\NormalTok{  firesm6sel2\_for\_comparison\_tb}\SpecialCharTok{$}\NormalTok{monthly\_sum,}
\NormalTok{  firesv1sel2\_tb}\SpecialCharTok{$}\NormalTok{monthly\_sum,}
  \AttributeTok{max.lag =} \DecValTok{8}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.75\linewidth]{img/data-download-preparation-eda/unnamed-chunk-1-7} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(}\FunctionTok{ccf}\NormalTok{(firesm6sel2\_for\_comparison\_tb}\SpecialCharTok{$}\NormalTok{monthly\_sum, firesv1sel2\_tb}\SpecialCharTok{$}\NormalTok{monthly\_sum, }\AttributeTok{lag.max =} \DecValTok{6}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.5\linewidth]{img/data-download-preparation-eda/year-of-gross-forest-cover-loss-nationwide-by-year-1} \end{center}
...
\begin{center}\includegraphics{img/data-download-preparation-eda/zonal-prov-2} \end{center}
...
\begin{center}\includegraphics{img/data-download-preparation-eda/zonal-prov-3} \end{center}
...
\begin{center}\includegraphics{img/data-download-preparation-eda/zonal-mun-2} \end{center}
...
\begin{center}\includegraphics{img/data-download-preparation-eda/zonal-mun-3} \end{center}
...
\begin{center}\includegraphics{img/data-download-preparation-eda/zonal-pa-2} \end{center}
...
\begin{center}\includegraphics{img/data-download-preparation-eda/zonal-pa-4} \end{center}
...
\begin{center}\includegraphics{img/data-download-preparation-eda/zonal-long-term-grid-2} \end{center}
